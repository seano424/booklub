class BookApiFetcher
  ...
  def execute
    ...
    isbn                = doc2['items']['volumeInfo']['industryIdentifiers'][0]['identifier']
    title             = doc2['items']['volumeInfo']['title']
    # authors           = doc2['items']['volumeInfo']['authors']
    description       = doc2['items']['volumeInfo']['description']
    page_count          = doc2['items']['volumeInfo']['pageCount']
    categories          = doc2['items']['volumeInfo']['categories']
    avg_rating          = doc2['items']['volumeInfo']['avgRating']
    image               = doc2['items']['volumeInfo']['imageLinks']['thumbnail']
