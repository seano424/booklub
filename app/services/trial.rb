class GoogleApiFetcher
  ...
  def execute
    ...
    img_links = google_doc['volumeInfo']['imageLinks']
    { authors: authors, title: title, description: description, page_count: page_count, categories: categories, avg_rating: avg_rating, img_links: img_links }
  end
end
